...
とりあえず以下のコマンドをそのまま流していけると思います。自分は権限の都合上sudoつけてますがroot権限で入ってもらえれば楽かと思いますのでお好きな方法でやって頂ければと思います。
...
この`eth0`は実際のNICに書き換えてやらないといけないんですが書き換える場合ってRaspbbery piを無線でつなげてる時ぐらいだろ。。とか思ってたわけですよ。いや???まてよ。
