...
ちなみにAnsible(Pythonベースのオープンソースの構成管理ツール)でもParamikoが使われているみたい。
...
今回は簡単なscriptでsshをやってみたわけですが、今後はTeratermマクロのような
...
[YAMAGUCHI::weblog](https://ymotongpoo.hatenablog.com/entry/20120205/1328406102)

[raw3h.net](https://ja.raw3h.net/page/paramiko-how-to-ssh-and-transfer-files-with-python-ccd91f/)

[情報科学屋さんを目指す人のメモ](https://did2memo.net/2017/07/31/jupyter-notebook-ssh/#stdoutread)
